...
This module defines the strictly typed schemas, custom database types,
and naming conventions required for the Postgres database.
"""
...
class Store(Base):
    """Represents a retail entity (e.g., MyTek, TunisNet, Scoop)."""
...
class Product(Base):
    """Represents a unique tracked item (e.g., MacBook Pro M3)."""
...
class ProductPricingHistory(Base):
    """Records daily pricing snapshots for products across different stores."""
